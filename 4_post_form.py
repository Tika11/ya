...
# @app.route("/login_json", methods=["POST"])
# def login():
# 	namakonser = request.json.get('namakonser')
# 	tanggalmulai = request.json.get('tanggalmulai')
#     tanggalselesai = request.json.get('tanggalselesai')
# 	section = request.json.get('section')
# 	harga = request.json.get('harga')
# 	print('namakonser: ', namakonser)
# 	print('tanggalmulai: ', tanggalmulai)
# 	print('tanggalselesai: ', tanggalselesai)
# 	print('section: ', section)
# 	print('harga: ', harga)
	
# 	conn = get_db_connection()
# 	cur = conn.cursor()
# 	strQuery = "SELECT * FROM konser where namakonser='%s' and tanggalmulai='%s' and tanggalseleai='%s' and section='%s' and harga='%s';" % (namakonser, tanggalmulai, tanggalselesai, section, harga)
# 	print('strQuery: ',strQuery)
# 	cur.execute(strQuery)
# 	user = cur.fetchall()
